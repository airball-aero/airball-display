...
#include "../airball/model/telemetry/FakeTelemetry.h"
#include "log_reader_telemetry_client.h"

#include "../telemetry/xbee_telemetry_client.h"
#include "../telemetry/udp_telemetry_client.h"
#include "../screen/x11_screen.h"
#include "../screen/framebuffer_screen.h"
...
int main(int argc, char **argv) {
  ...
  std::unique_ptr<airball::TelemetryClient> telemetry;
  {
    ...
    if (v == "fake") {
      ...
      telemetry = std::unique_ptr<airball::TelemetryClient>
          (new airball::UdpTelemetryClient());
    } else {
